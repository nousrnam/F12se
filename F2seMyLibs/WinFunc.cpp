...
{
    const void* startPath = (const void*)param;
...
bool BrowseDialog(const std::string& Title, HWND owner, std::string& path)
{
    ...
    BrowseInfo.ulFlags = BIF_EDITBOX | BIF_RETURNONLYFSDIRS | BIF_NEWDIALOGSTYLE;
    BrowseInfo.lpfn = BrowseCallbackProc;
#if _MSC_VER
    // MSVC needs wide string to pass in BFFM_SETSELECTION message
    const std::wstring pathW = LocalStringToWide(path);
    BrowseInfo.lParam = (LPARAM)pathW.c_str();
#else
